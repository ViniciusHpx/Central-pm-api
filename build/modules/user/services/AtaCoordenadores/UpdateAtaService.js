...
class UpdateAtaService {
    execute({ id, titulo, link }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!id) {
                throw new AppError_1.default('Ata não informada');
            }
            if (!titulo || !link) {
            ...
            const ataExiste = yield AtaCoordenadores_1.default.findById(id);
            if (!ataExiste) {
                throw new AppError_1.default('Ata não encontrado');
            }
            yield AtaCoordenadores_1.default.findByIdAndUpdate(id, {
                titulo,
                link,
            });
            const ataAtualizado = yield AtaCoordenadores_1.default.findOne({ _id: id });
            if (!ataAtualizado) {
...
exports.default = UpdateAtaService;
