...
class DeleteComissaoEmergenciaService {
    execute({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            const comissaoEmergenciaExiste = yield ComissaoEmergencia_1.default.findOne({
                _id: id,
            });
            if (!comissaoEmergenciaExiste) {
                throw new AppError_1.default('Aviso não encontrado');
            }
            cache_1.default.del('comissaoEmergencia');
            yield ComissaoEmergencia_1.default.deleteOne({ _id: id });
        });
    }
}
exports.default = DeleteComissaoEmergenciaService;
