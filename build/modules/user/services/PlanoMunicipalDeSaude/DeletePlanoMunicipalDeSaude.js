...
class DeletePlanoMunicipalDeSaudeService {
    execute({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            const planoMunicipalDeSaudeExiste = yield PlanoMunicipalDeSaude_1.default.findOne({
                _id: id,
            });
            ...
            yield PlanoMunicipalDeSaude_1.default.deleteOne({ _id: id });
        });
    }
}
exports.default = DeletePlanoMunicipalDeSaudeService;
