...
class DeleteLancamentosService {
    execute({ id }) {
        return __awaiter(this, void 0, void 0, function* () {
            const lancamentosExiste = yield Lancamentos_1.default.findOne({ _id: id });
            if (!lancamentosExiste) {
                throw new AppError_1.default('Aviso não encontrado');
            }
            cache_1.default.del('lancamentos');
            yield Lancamentos_1.default.deleteOne({ _id: id });
        });
    }
}
exports.default = DeleteLancamentosService;
