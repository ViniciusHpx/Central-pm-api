...
class UpdateAvisoService {
    execute({ id, titulo, tipo, conteudo, data, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const avisoExiste = yield Avisos_1.default.findById(id);
            if (!avisoExiste) {
                throw new AppError_1.default('Aviso não encontrado');
            }
            yield Avisos_1.default.findByIdAndUpdate(id, {
                titulo,
                tipo,
                conteudo,
                data,
            });
            const avisoAtualizado = yield Avisos_1.default.findOne({ _id: id });
            if (!avisoAtualizado) {
...
exports.default = UpdateAvisoService;
