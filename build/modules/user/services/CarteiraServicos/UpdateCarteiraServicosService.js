...
class UpdateCarteiraServicosService {
    execute({ id, titulo, link, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const carteiraServicoExiste = yield CarteiraServicos_1.default.findById(id);
            if (!carteiraServicoExiste) {
                throw new AppError_1.default('Carteira Servicos não encontrado');
            }
            yield CarteiraServicos_1.default.findByIdAndUpdate(id, {
                titulo,
                link,
            });
            const carteiraServicoAtualizado = yield CarteiraServicos_1.default.findOne({
                _id: id,
            });
...
exports.default = UpdateCarteiraServicosService;
